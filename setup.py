...
setup(name='prodview',
      ...
      data_files=[('/etc/', ['packaging/prodview.conf']),
                  ...
                  ('/etc/cron.d/', ['packaging/prodview.cron', 'packaging/analysisview.cron', 'packaging/totalview.cron', 'packaging/utilization.cron', 'packaging/cleanup.cron', 'packaging/cmsconnectview.cron', 'packaging/institutionalview.cron', 'packaging/condormonitoringcron.cron']),
      ...
      scripts=["src/prodview-update", "src/analysisview-update", "src/analysisviewcrab2-update", "src/totalview-update", "src/utilization", "src/cmsconnect-update", "src/institutional-update", "src/functions.py", "src/timeout.py"]
     )
