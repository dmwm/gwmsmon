...
setup(name='prodview',
      ...
      data_files=[('/etc/', ['packaging/prodview.conf']),
                  ...
                  ('/etc/cron.d/', ['packaging/prodview.cron', 'packaging/analysisview.cron', 'packaging/analysiscrab2.cron', 'packaging/totalview.cron', 'packaging/utilization.cron', 'packaging/history.cron', 'packaging/cleanup.cron']),
      ...
      scripts=["src/prodview-update", "src/analysisview-update", "src/analysisviewcrab2-update", "src/totalview-update", "src/utilization", "src/functions.py", "src/history-update"]
     )
