...
setup(name='prodview',
      ...
      data_files=[('/etc/', ['packaging/prodview.conf']),
                  ...
                  ('/etc/cron.d/', ['packaging/prodview.cron', 'packaging/analysisview.cron', 'packaging/analysiscrab2.cron', 'packaging/totalview.cron', 'packaging/utilization.cron', 'packaging/cleanup.cron']),
